...
{
       0,    33,    33,    36,    40,    42,    47,    48,    52,    57,
      62,    70,    75,    82,    83,    84,    88,    90,   130,   138,
     142,   142,   147,   156,   164,   167,   177,   187,   197,   206,
     211,   218,   210
};
#endif
...
{
  "$end", "error", "$undefined", "tIF", "tELSE", "tWHILE", "tMAIN",
  "tACCG", "tACCD", "tPRINTF", "tPG", "tPD", "tCONST", "tINT", "tFLOAT",
  "tINT_NUM", "tFLOAT_NUM", "tNAME", "tPLUS", "tMOINS", "tSLASH", "tSTAR",
  "tEQUAL", "tINF", "tSUP", "tSPACE", "tCOMA", "tET", "tPCOMA", "tTAB",
  "tENTREE", "$accept", "Main", "Body", "Declarations", "Declaration",
  "Declaration_else", "Instructions", "Instruction", "Printf", "Type",
  "Expression", "Comparaison", "$@3", "$@4", YY_NULLPTR
};
#endif
...
{
      -1,    20,     3,    -4,   -31,    13,    29,   -31,   -31,   -31,
     -31,    -8,    27,    24,    46,    35,    50,    31,   -31,    10,
     -20,    -7,    11,   -31,    -8,   -31,    45,    44,   -31,    51,
      11,   -31,   -31,    32,   -31,   -31,   -31,    37,   -31,   -31,
      -3,    11,    11,    11,    11,    42,    44,   -31,    19,    19,
     -31,   -31,    11,   -31,    32,    11,    26,    11,    32,    11,
      14,    11,    32
};
...
{
       3,     0,     0,     0,     1,     0,     0,     2,     5,    20,
      21,    15,     0,     0,     0,     0,     0,     0,    16,     7,
      10,     0,     0,     4,    14,     6,     0,     0,    19,     0,
       0,    23,    22,    17,    29,    13,     8,    12,     9,    18,
       0,     0,     0,     0,     0,     0,     0,    24,    25,    27,
      28,    26,     0,    11,    30,     0,     0,     0,    31,     0,
       0,     0,    32
};
...
{
      40,    14,    26,     4,    28,     1,    27,     5,    47,    15,
      29,    48,    49,    50,    51,    41,    42,    43,    44,    45,
       6,    30,    54,     9,    10,    56,    31,    58,    32,    60,
       3,    62,    41,    42,    43,    44,    45,     8,    61,    43,
      44,    20,     9,    10,    41,    42,    43,    44,    45,    57,
      41,    42,    43,    44,    45,    19,    21,    22,    23,    24,
      36,    37,    39,    46,    52,    35,    25,    53
};

static const yytype_uint8 yycheck[] =
{
      30,     9,    22,     0,    11,     6,    26,    11,    11,    17,
      17,    41,    42,    43,    44,    18,    19,    20,    21,    22,
       7,    10,    52,    13,    14,    55,    15,    57,    17,    59,
      10,    61,    18,    19,    20,    21,    22,     8,    24,    20,
      21,    17,    13,    14,    18,    19,    20,    21,    22,    23,
      18,    19,    20,    21,    22,    28,    10,    22,     8,    28,
      15,    17,    11,    26,    22,    24,    19,    46
};
...
{
       0,     6,    32,    10,     0,    11,     7,    33,     8,    13,
      14,    34,    35,    40,     9,    17,    37,    38,    39,    28,
      17,    10,    22,     8,    28,    34,    22,    26,    11,    17,
      10,    15,    17,    41,    42,    37,    15,    17,    36,    11,
      41,    18,    19,    20,    21,    22,    26,    11,    41,    41,
      41,    41,    22,    36,    41,    43,    41,    23,    41,    44,
      41,    24,    41
};
...
#line 1332 "y.tab.c" /* yacc.c:1646  */
  ...
  case 5:
#line 43 "lex.y" /* yacc.c:1646  */
    {printf ("Body vide\n");}
#line 1338 "y.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 53 "lex.y" /* yacc.c:1646  */
    {
        printf ("Declaration et initialisation\n");
        addVar((yyvsp[-2].string));
    }
...
#line 1356 "y.tab.c" /* yacc.c:1646  */
  ...
  case 10:
#line 63 "lex.y" /* yacc.c:1646  */
    {
        printf ("Declaration simple\n");
        addVar((yyvsp[0].string));
    }
...
#line 91 "lex.y" /* yacc.c:1646  */
    {
        ...
        int address = getAddress((yyvsp[-2].string));
        int addressVar = pop();
...
#line 131 "lex.y" /* yacc.c:1646  */
    {
        //int address = push();
        int address = getAddress((yyvsp[-1].string));
...
#line 148 "lex.y" /* yacc.c:1646  */
    {
        printf ("tNAME \n");
        int address = push();
        int tNameAddress = getAddress((yyvsp[0].string));
...
#line 157 "lex.y" /* yacc.c:1646  */
    {
        ...
        add_instruc("AFC",address,(yyvsp[0].integer),-1);
    }
